...
public class Vmap extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_vmap);
        ...
        Button navDetails = findViewById(R.id.nav_details);
        Button navMap = findViewById(R.id.nav_map);

        navHome.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Vmap.this, WelcomePage.class));
            }
        });

        navDetails.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Vmap.this, Details.class));
            }
        });
        ...
        navMap.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Vmap.this, Vmap.class));
            }
        });
    }
